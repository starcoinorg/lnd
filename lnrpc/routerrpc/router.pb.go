...
/*
Package routerrpc is a generated protocol buffer package.
...
type PaymentRequest struct {
	...
	// returned.
	FeeLimitSat int64 `protobuf:"varint,2,opt,name=fee_limit_sat,json=feeLimitSat" json:"fee_limit_sat,omitempty"`
	// *
	...
	// be returned.
	CltvLimit int32 `protobuf:"varint,3,opt,name=cltv_limit,json=cltvLimit" json:"cltv_limit,omitempty"`
	// *
	...
	OutgoingChannelId int64 `protobuf:"varint,5,opt,name=outgoing_channel_id,json=outgoingChannelId" json:"outgoing_channel_id,omitempty"`
}
...
type PaymentResponse struct {
	...
	PaymentErr string `protobuf:"bytes,3,opt,name=payment_err,json=paymentErr" json:"payment_err,omitempty"`
}
...
type RouteFeeRequest struct {
	...
	AmtSat int64 `protobuf:"varint,2,opt,name=amt_sat,json=amtSat" json:"amt_sat,omitempty"`
}
...
func (*RouteFeeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
type RouteFeeResponse struct {
	...
	RoutingFeeMsat int64 `protobuf:"varint,1,opt,name=routing_fee_msat,json=routingFeeMsat" json:"routing_fee_msat,omitempty"`
	// *
	// An estimate of the worst case time delay that can occur. Note that callers
	// will still need to factor in the final CLTV delta of the last hop into this
	// value.
	TimeLockDelay int64 `protobuf:"varint,2,opt,name=time_lock_delay,json=timeLockDelay" json:"time_lock_delay,omitempty"`
}
...
func (*RouteFeeResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (c *routerClient) SendPayment(ctx context.Context, in *PaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
	...
	err := grpc.Invoke(ctx, "/routerrpc.Router/SendPayment", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) EstimateRouteFee(ctx context.Context, in *RouteFeeRequest, opts ...grpc.CallOption) (*RouteFeeResponse, error) {
	...
	err := grpc.Invoke(ctx, "/routerrpc.Router/EstimateRouteFee", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("routerrpc/router.proto", fileDescriptor0) }
